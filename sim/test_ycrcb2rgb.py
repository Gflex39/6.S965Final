...
@cocotb.test()
async def test_ycrcb2rgb(dut):
    """cocotb test for ycrcb2rgb"""
...
def ycrcb2rgb_runner():
    ...
    sources = [proj_path / "hdl" / "ycrcb2rgb.sv"]
