...
set_property -dict {PACKAGE_PIN C12 IOSTANDARD LVCMOS33}  [ get_ports "gem_tx_clk" ]
set_property -dict {PACKAGE_PIN H14 IOSTANDARD LVCMOS33}  [ get_ports "gem_tx[0]" ]
set_property -dict {PACKAGE_PIN H13 IOSTANDARD LVCMOS33}  [ get_ports "gem_tx[1]" ]
set_property -dict {PACKAGE_PIN J14 IOSTANDARD LVCMOS33}  [ get_ports "gem_tx[2]" ]
set_property -dict {PACKAGE_PIN F15 IOSTANDARD LVCMOS33}  [ get_ports "gem_tx[3]" ]
set_property -dict {PACKAGE_PIN J16 IOSTANDARD LVCMOS33}  [ get_ports "gem_tx_ctrl" ]
