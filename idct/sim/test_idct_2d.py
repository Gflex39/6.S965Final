...
def transpose_matrix(matrix):
    ...
    transposed = [[0 for _ in range(8)] for _ in range(8)]
...
@cocotb.test()
async def test_idct_2d(dut):
    """cocotb test for idct_2d"""
    cocotb.start_soon(Clock(dut.clk_in, 10, units="ns").start())

    # await set_ready(dut, 1)
    await reset(dut.clk_in, dut.rst_in, 2, 0)
    ...
    for test_input in test_inputs:
        ...
        while dut.valid_out.value == 1:
            ...
            idct_out_0 = dut.idct_out_0.value.signed_integer
            idct_out_1 = dut.idct_out_1.value.signed_integer
            idct_out_2 = dut.idct_out_2.value.signed_integer
            idct_out_3 = dut.idct_out_3.value.signed_integer
            idct_out_4 = dut.idct_out_4.value.signed_integer
            idct_out_5 = dut.idct_out_5.value.signed_integer
            idct_out_6 = dut.idct_out_6.value.signed_integer
            idct_out_7 = dut.idct_out_7.value.signed_integer
    ...
    dut.idct_in_0.value = 0
    dut.idct_in_1.value = 0
    dut.idct_in_2.value = 0
    dut.idct_in_3.value = 0
    dut.idct_in_4.value = 0
    dut.idct_in_5.value = 0
    dut.idct_in_6.value = 0
    dut.idct_in_7.value = 0
...
async def input_data(dut, value):
    ...
    for i in range(8):
        ...
        print("Expected IDCT Results: ", idct(input, norm="ortho"))
...
def idct_2d_runner():
    ...
    sources = [
        proj_path / "hdl" / "idct_2d.sv",
        proj_path / "hdl" / "idct_1d.sv",
        proj_path / "hdl" / "matrix_transpose_buffer.sv",
    ]
