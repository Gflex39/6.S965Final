...
set_property -dict {PACKAGE_PIN Y18 IOSTANDARD LVCMOS33}  [ get_ports "gem_mdio" ]
set_property -dict {PACKAGE_PIN U18 IOSTANDARD LVCMOS33}  [ get_ports "gem_mdc" ]

set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS33}  [ get_ports "gem_rx[0]"]
set_property -dict {PACKAGE_PIN Y14 IOSTANDARD LVCMOS33}  [ get_ports "gem_rx[1]" ]
set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33}  [ get_ports "gem_rx[2]" ]
set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33}  [ get_ports "gem_rx[3]" ]
set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS33}  [ get_ports "gem_rx_clk"]
set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS33}  [ get_ports "gem_rx_ctrl" ]

set_property -dict {PACKAGE_PIN V13 IOSTANDARD LVCMOS33}  [ get_ports "gem_tx_clk" ]
set_property -dict {PACKAGE_PIN Y17 IOSTANDARD LVCMOS33}  [ get_ports "gem_tx[0]" ]
set_property -dict {PACKAGE_PIN Y16 IOSTANDARD LVCMOS33}  [ get_ports "gem_tx[1]" ]
set_property -dict {PACKAGE_PIN U19 IOSTANDARD LVCMOS33}  [ get_ports "gem_tx[2]" ]
set_property -dict {PACKAGE_PIN Y19 IOSTANDARD LVCMOS33}  [ get_ports "gem_tx[3]" ]
set_property -dict {PACKAGE_PIN W13 IOSTANDARD LVCMOS33}  [ get_ports "gem_tx_ctrl" ]
# ## Arduino GPIO
...
# ## HDMI signals
create_clock -period 8.334 -waveform {0.000 4.167} [get_ports {clk_100mhz}]
